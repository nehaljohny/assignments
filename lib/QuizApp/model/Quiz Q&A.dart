List<Map<String, dynamic>> queAns = [
  ...
  {
    'question': "In which city is Hollywood located?",
  ...
  {
    'question':
        "Who played the character of Luke Skywalker in the original “Star Wars” trilogy?",
    'options': [
      'Mark Hamill',
      'Harrison Ford',
      'Carrie Fisher',
  ...
  {
    'question':
        "Who directed the film “Pulp Fiction,” which won the Palme d’Or at the 1994 Cannes Film Festival?",
    'options': [
      'Quentin Tarantino',
      'Stanley Kubrick',
      'Steven Spielberg',
  ...
  {
    'question':
        " Who directed the film “Gone Girl” based on the novel by Gillian Flynn?",
    'options': [
      'David Fincher',
      'Christopher Nolan',
      'Wes Anderson',
  ...
  {
    'question':
        "Who won the Academy Award for Best Actor in a Leading Role 2017?",
    'options': [
      'Casey Affleck',
      'Andrew Garfield',
      'Denzel Washington',
